    ...
    <div class="space-y-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <p class="text-sm text-yellow-800">
                            <strong>Email belum diverifikasi.</strong> Silakan periksa inbox email Anda untuk memverifikasi akun.
                        </p>
                    </div>
                    <div class="ml-4">
                        <a href="{{ route('verification.notice') }}" class="text-sm bg-yellow-600 hover:bg-yellow-700 text-white px-3 py-1 rounded font-medium">
                            Verifikasi Sekarang
                        </a>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Ready to convert some files today?</p>
                </div>
                <div class="flex space-x-3">
                    <a href="#" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition duration-200">
                        Convert Files
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $stats['storage_used'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                                ...
                                @foreach($stats['recent_conversions'] as $conversion)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">{{ $conversion->original_filename }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                                    {{ strtoupper($conversion->original_extension) }}
                                                </span>
                                                ...
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                    {{ strtoupper($conversion->target_extension) }}
                                                </span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            {{ $conversion->file_size_human }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @php
                                                $statusClasses = [
                                            ...
                                            @endphp
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $statusClasses[$conversion->status] }}">
                                                {{ ucfirst($conversion->status) }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {{ $conversion->created_at->format('M j, Y') }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            @elseif($conversion->status === 'failed')
                                                <span class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-red-600">
                                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Get started by converting your first file.</p>
                        <div class="mt-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="{{ route('tools.documents') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-200">
                    ...
                    <div>
                        <p class="font-medium text-gray-900">Document Convert</p>
                        <p class="text-sm text-gray-500">PDF, Word, Excel, PPT</p>
                    </div>
                </a>
                ...
                <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-200">
                    ...
                    <div>
                        <p class="font-medium text-gray-900">Image Convert</p>
                        <p class="text-sm text-gray-500">JPG, PNG, WebP</p>
                    </div>
                </a>
                ...
                <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-200">
                    ...
                    <div>
                        <p class="font-medium text-gray-900">Audio Convert</p>
                        <p class="text-sm text-gray-500">MP3, WAV, FLAC</p>
                    </div>
                </a>
                ...
                <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-200">
                    ...
                    <div>
                        <p class="font-medium text-gray-900">Video Convert</p>
                        <p class="text-sm text-gray-500">MP4, AVI, WebM</p>
                    </div>
                </a>
            </div>
        </div>
